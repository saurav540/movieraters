...
<html>
	...
	<body class="profile-page sidebar-collapse" ng-app="crudApp" ng-controller="crudController" style="background-color: #000000;" >
        ...
        <div class="container">
            ...
            <div class="navbar-translate">
                <a class="navbar-brand" href="www.beedesigns.cf" data-placement="bottom" target="_blank">
                    Movie IMBD
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="addactor.html">Add Actor</a>
                    </li>
    ...
    <div class="wrapper">
        <div class="page-header page-header-small" filter-color="#">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../img/bg3.jpg');">
            </div>
            <div class="container">
                <div class="content-center" style="padding-top: 360px; padding-right: 600px;">
                    <div class="button-container">
                    <h1 class="title">Panther</h1>
                    <p>FIGHT || COMIC || SUPERHERO</p>
